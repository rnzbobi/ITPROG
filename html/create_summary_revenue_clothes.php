...
$getData=mysqli_query($conn, 
            "SELECT ic.id, ic.name, ic.size, ic.image_URL, ROUND(SUM(oi.subtotal),2) AS 'total_revenue'
            FROM order_items oi
...
$summary = $xml->createElement("summary_revenue");
...
while($obtainSummary=mysqli_fetch_assoc($getData)){
    ...
    $revenue = $xml->createElement("revenue", $obtainSummary['total_revenue']);
...
$xml->save("summary_revenue_clothes.xml");
$xml = simplexml_load_file('summary_revenue_clothes.xml') or die ("Error cannot create object!");
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
echo "<div class='sum_sold_interface'>";
    echo "<div class='sum_sold-header'>";
        ...
        echo "<div class='sum_sold_title-mid'>";
            echo "Item and Size";
        echo "</div>";
        echo "<div class='revenue_sold_title-right'>";
            echo "Total Revenue";
        echo "</div>";
        echo "<div class='revenue_sold_title-rank'>";
            echo "Rank";
        echo "</div>";
    echo "</div>";
